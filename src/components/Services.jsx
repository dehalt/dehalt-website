  ...
  return (
    ...
    >
      <div className="flex w-[95%] flex-col gap-6 border-r border-l border-gray-200 bg-[#f0f0f0] px-3 pt-10 pb-10 md:px-6 lg:px-8 2xl:w-376">
        ...
        <div className="relative flex h-fit w-full flex-col gap-1.5 xl:flex-row xl:gap-3.5">
          <motion.div
            variants={fadeUp}
            className="flex h-160 flex-col gap-2 rounded-3xl bg-[#E5E5E5] p-2 sm:h-200 md:h-fit md:flex-row xl:w-fit xl:flex-col"
          >
            <div className="flex h-fit min-h-74 w-full max-w-170 min-w-100 flex-col gap-3 rounded-3xl bg-[#F0F0F0] p-6 md:h-100 xl:h-fit xl:min-w-113 2xl:min-h-74">
